...
# with command line options: step4 --conditions auto:phase1_2018_realistic -s HARVESTING:@standardValidationNoHLT+@standardDQMFakeHLT+@miniAODValidation+@miniAODDQM --scenario pp --filetype DQM --geometry DB:Extended --era Run2_2018 --mc -n 100 --no_exec --filein file:step3_inDQM.root --fileout file:step4.root
...
# Schedule definition
process.schedule = cms.Schedule(process.validationHarvestingNoHLT,process.dqmHarvestingFakeHLT,process.validationHarvestingMiniAOD,process.DQMHarvestMiniAOD_step,process.dqmsave_step)
